// ClientNPсt.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
	...
	try
	{
		for (int i = 0; i < 100; i++)
		{
			if (!CallNamedPipe(L"\\\\.\\pipe\\Tube", wbuf, wb, rbuf, rb, &rb, 20))
